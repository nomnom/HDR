...
## separate
 ...
 echo " `graph_plotargs $size `;
        ...
        set yrange[0:1.1];
        set grid;
        plot 'tmp_$i.dat' u (\$3/2.430620):(\$2/65535)  w l t '${names[i]}' ls `echo $i + 1 | bc` , x/0.8  t 'x/0.8' lt 2 lc rgb 'black'" | gnuplot
 ...
 # as log-log plot
  echo " `graph_plotargs $size `;
        ...
        set yrange[-2.8:0.2];
        set grid;
        plot 'tmp_$i.dat' u (log10(\$3/2.430620)):(log10(\$2/65535))  w l t '${names[i]}' ls `echo $i + 1 | bc` " | gnuplot
...
## as one combined plot 
 ...
 echo " `graph_plotargs $size `;
        ...
        set yrange[0:1.1];
        set grid;
        plot 'tmp_0.dat' u (\$3/2.430620):(\$2/65535)  w l t '${names[0]}' ls 1, 'tmp_1.dat' u (\$3/2.430620):(\$2/65535)  w l t '${names[1]}' ls 2, 'tmp_2.dat' u (\$3/2.430620):(\$2/65535)  w l t '${names[2]}' ls 3 " | gnuplot 
 ...
 # as log-log plot
  echo " `graph_plotargs $size `;
        ...
        set yrange[-2.8:0.2];
        set grid;
        plot 'tmp_0.dat' u (log10(\$3/2.430620)):(log10(\$2/65535))  w l t '${names[0]}' ls 1,  'tmp_1.dat' u (log10(\$3/2.430620)):(log10(\$2/65535))  w l t '${names[1]}' ls 2, 'tmp_2.dat' u (log10(\$3/2.430620)):(log10(\$2/65535))  w l t '${names[2]}' ls 3 " | gnuplot
